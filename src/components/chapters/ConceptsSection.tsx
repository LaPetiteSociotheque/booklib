  ...
  return (
    <section className="my-12">
      ...
      <div className="bg-[#f4e9dd] border border-[#e0d4c4] p-6 rounded-xl">
        <div
          className="text-[#2E2A26] text-base leading-relaxed font-serif prose prose-p:my-4 prose-headings:text-[#B74E22] prose-headings:font-semibold prose-a:text-[#B74E22]"
